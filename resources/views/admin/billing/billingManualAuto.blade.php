...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <form method="post" action="{{ route('billingManualAutoChk') }}">
            @csrf
            <div class="card-body">
                <!-- /.card-header -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="parameter_id" class="form-control select2" style="width: 100%;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="month_billing" class="form-control" type="month" id="start" name="start" min="2022-01">
                        </div>
                    </div>
                </div>
            </div>
